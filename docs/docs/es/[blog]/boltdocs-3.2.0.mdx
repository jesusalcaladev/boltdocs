...
<Callout type="info">
  Consultá la [doc completa de `@bdocs/unist-utils`](/docs/es/plugins/content/unist-utils) para la referencia de API, guía de migración y ejemplos.
</Callout>
...
<Callout type="info">
  Consultá la [Plugin API Reference](/docs/es/api/plugin-api) completa. La API se separó en páginas dedicadas — [Caches](/docs/es/api/plugin-api/caches), [Diagnostics](/docs/es/api/plugin-api/diagnostics), [Paths](/docs/es/api/plugin-api/paths), [Virtual Modules](/docs/es/api/plugin-api/virtual-modules), [Middleware](/docs/es/api/plugin-api/middleware), [Server](/docs/es/api/plugin-api/server), y [HMR](/docs/es/api/plugin-api/hmr).
</Callout>
...
Consultá la [Middleware API docs](/docs/es/api/plugin-api#ctxmiddleware--pluginmiddlewareapi) para la referencia completa.
...
<Timeline>
  ...
  >
    ...
    modules, middleware, server y hooks HMR. Consultá la [guía de migración](/docs/es/blog/boltdocs-3.2.0).
  </Timeline.Item>
...
<Callout type="info">
  Consultá la [doc completa de Timeline](/docs/es/components/mdx/timeline) para ver la API completa, notas de accesibilidad y el patrón de changelog guiado por datos.
</Callout>
