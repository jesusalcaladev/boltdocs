...
| :--- | :--- | :--- | :--- |
| `primary` | azul | azul | Hito genérico. |
...
- Cada punto mantiene su acento semántico — el azul sigue siendo azul; el rojo danger no se tiñe de rosa.
...
- El [último post de release](/docs/es/blog/boltdocs-3.3.0) — la mayoría de los posts de release de Boltdocs usan `<Timeline>` para renderizar sus changelogs.
