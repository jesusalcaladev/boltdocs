...
Install it with `pnpm add @bdocs/plugin-math`, add `mathPlugin()` to your config plugins, and you're done. Read the [plugin-math docs](/docs/plugins/content/plugin-math) for details.
