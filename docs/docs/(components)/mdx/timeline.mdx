...
| :--- | :--- | :--- | :--- |
| `primary` | azure blue | azure blue | Generic milestone. |
...
- Each dot keeps its semantic accent — azure stays azure; the danger-red doesn't tint into pink.
...
- The [latest release post](/docs/blog/boltdocs-3.3.0) — most Boltdocs release posts use `<Timeline>` to render their changelogs.
