...
- [Installation guide](/docs/guides/getting-started/installation) — fresh-install flow
- [Plugin authoring guide](/docs/plugins) — for plugin authors affected by the icons split
- [Boltdocs config reference](/docs/guides/getting-started/configuration) — full config schema
