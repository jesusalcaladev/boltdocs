  ...
  return (
    <DocsLayout>
      ...
      <div aria-hidden="true">
        <div className="absolute -top-[10%] -left-[10%] w-[40%] h-[40%] rounded-full bg-primary-500/15 blur-[120px]" />
        <div className="absolute -top-[5%] -right-[5%] w-[35%] h-[35%] rounded-full bg-purple-500/5 blur-[100px]" />
        <div className="absolute top-[20%] left-[20%] w-[20%] h-[20%] rounded-full bg-blue-400/4 blur-[80px]" />
      </div>
      <Head
